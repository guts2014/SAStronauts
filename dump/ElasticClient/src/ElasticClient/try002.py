...
criterion_doubtterr="",alternative="",multiple="",success="",suicide="",attacktype="",target_atktype="",target_atksubtype="",target_corp="",target_atktarget="",target_natio="",groupname="",groupsubname="",motive="",groupconfirmed="",perpetrators="",perpetratorscaptured="",claimed="",wep_type="",wep_subtype="",wep_detail="",kills="",wounds="",
       ...
       "target":
        {
            ...
            "atksubtype": target_atksubtype, # type: string
            "corporation": target_corp, # type: string
            "atktarget": target_atktarget, # type: string 
...
def main():
    for idx in test2.data:
        print("IDX = "+idx+"\t"+test2.data[idx]["atacktype"]+"\t"+test2.data[idx]["target"]["type"]+"\n")
        es.index(index="terrorist", doc_type="data", id = idx, body = getdata(date_year = test2.data[idx]["date"]["year"],
                                                                              ...
                                                                              loc_country = test2.data[idx]["location"]["country"],
                                                                              loc_region = test2.data[idx]["location"]["region"],
                                                                              ...
                                                                              alternative = test2.data[idx]["alternative"],
                                                                              multiple = test2.data[idx]["multiple"],
                                                                              success = test2.data[idx]["success"],
                                                                              suicide = test2.data[idx]["suicide"],
                                                                              #attacktype = test2.data[idx]["attacktype"], # wrong!
                                                                              #target_atktype = test2.data[idx]["target"]["type"], # wrong!
                                                                              target_atksubtype = test2.data[idx]["target"]["subtype"],
                                                                              target_corp = test2.data[idx]["target"]["corporation"],
                                                                              target_atktarget = test2.data[idx]["target"]["target"],
                                                                              target_natio = test2.data[idx]["target"]["nationality"],
